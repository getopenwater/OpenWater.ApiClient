...
namespace OpenWater.ApiClient.JudgeScorecard
{
    ...
    public partial class JudgeScorecardListItemModel 
    {
        ...
        [Newtonsoft.Json.JsonConstructor]
        public JudgeScorecardListItemModel(string applicationCode, int applicationId, System.DateTimeOffset evaluationDateUtc, int id, int judgeUserId, int programId, int roundId, System.DateTimeOffset startedAtUtc, JudgeScorecardStatus status, double totalScore, System.DateTimeOffset? updatedAtUtc)
        {
              Id = @id;
              ProgramId = @programId;
              RoundId = @roundId;
