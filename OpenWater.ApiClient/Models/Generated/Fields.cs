...
namespace OpenWater.ApiClient.Fields
{
    ...
    public partial class FieldModelBase 
    {
        ...
        public FieldModelBase(string alias, string customCssClass, string description, bool? hidden, bool? isDescriptionWysiwyg, string name, bool? required, int? sortOrder, FieldVisibilityConditionModel visibilityCondition)
        {
              Alias = @alias;
              Name = @name;
