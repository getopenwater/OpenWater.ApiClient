...
namespace OpenWater.ApiClient.ApplicationCategory
{
    ...
    public partial class ApplicationCategoryListItemModel 
    {
        public ApplicationCategoryListItemModel() { }
    
        [Newtonsoft.Json.JsonConstructor]
        public ApplicationCategoryListItemModel(string code, int id, string name)
        {
              Id = @id;
              Name = @name;
              Code = @code;
